...
**Known issues with this feature** — see `FIXES.md` BUG-07 (Review-step description showing "Summary unavailable" instead of generating inline; duplicate ISBN scans hitting Gemini and then 409'ing on save).
